...
public class BronzeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bronze);
        ...
        btnCheckout.setOnClickListener(v -> {
            ...
            if (total > 0) {
                ...
                Intent intent = new Intent(BronzeActivity.this, PaymentActivity.class);
